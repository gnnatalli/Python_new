...
info = [animals + " весит " + str(weights) + " кг"
        for animals, weights in zip(animals, weights)]

min_weights = animals[weights.index(min(weights))]

print(info)

print("Самое лёгкое животное: ",min_weights)